...
static bool AKSM_prv_cpuminclock=0;
...
static unsigned int AKSM_mem_warn_level = 30720;  /* pages  , 120MB*/
static unsigned int AKSM_mem_critical_level = 10240; /* pages , 40MB*/
...
static void AKSM_cpu_boost_start(void)
{
	...
	cpufreq_update_universal_lmt_req(BITMAP_KERNEL_SPACE_DVFS_KSM,
					BOOST_MIN_CLOCK, MIN_LIMIT);
	AKSM_prv_cpuminclock = 1;

	print_aksm("KSM### AKSM Boost start\n");
