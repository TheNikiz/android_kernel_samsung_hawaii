...
/* ---- Include Files ---------------------------------------------------- */
#ifndef __HX8369_BOE_2_H__
#define __HX8369_BOE_2_H__
...
typedef enum {
	HX8369_CMD_BOE_2_NOP					= 0x00,
	HX8369_CMD_BOE_2_SLEEP_IN				= 0x10,		
	HX8369_CMD_BOE_2_SLEEP_OUT				= 0x11,	
	HX8369_CMD_BOE_2_DISP_ON				= 0x29,
	HX8369_CMD_BOE_2_DISP_OFF				= 0x28,
	HX8369_CMD_BOE_2_PIXEL					= 0x3A,
	HX8369_CMD_BOE_2_DISP_DIRECTION		= 0x36,	
	HX8369_CMD_BOE_2_PWR_CTL				= 0xB1,
	HX8369_CMD_BOE_2_RGB_SET				= 0xB3,	
	HX8369_CMD_BOE_2_DISP_INVERSION		= 0xB4,	
	HX8369_CMD_BOE_2_BGP_VOL				= 0xB5,
	HX8369_CMD_BOE_2_VCOM					= 0xB6,		
	HX8369_CMD_BOE_2_ENABLE_CMD			= 0xB9,
	HX8369_CMD_BOE_2_MIPI_CMD				= 0xBA,
	HX8369_CMD_BOE_2_GOA_CTL				= 0xD5,
	HX8369_CMD_BOE_2_SRC_OPT				= 0xC0,		
	HX8369_CMD_BOE_2_SRC_DGC_OFF			= 0xC1,			
	HX8369_CMD_BOE_2_SRC					= 0xC6,	
	HX8369_CMD_BOE_2_PANEL					= 0xCC,	
	HX8369_CMD_BOE_2_GAMMA					= 0xE0,	
	HX8369_CMD_BOE_2_EQ						= 0xE3,	
	HX8369_CMD_BOE_2_MESSI					= 0xEA,
	HX8369_CMD_BOE_2_BL					= 0x53,
} HX8369_CMD_BOE_2_T;

__initdata struct DSI_COUNTER hx8369_boe_2_timing[] = {
...
__initdata DISPCTRL_REC_T hx8369_boe_2_scrn_on[] = {
	{DISPCTRL_WR_CMND, HX8369_CMD_BOE_2_DISP_ON},
	{DISPCTRL_SLEEP_MS, 100},
	{DISPCTRL_WR_CMND, HX8369_CMD_BOE_2_BL},
	{DISPCTRL_WR_DATA, 0x2C},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T hx8369_boe_2_scrn_off[] = {
	{DISPCTRL_WR_CMND, HX8369_CMD_BOE_2_BL},
	{DISPCTRL_WR_DATA, 0x08},
	{DISPCTRL_SLEEP_MS, 50},
	{DISPCTRL_WR_CMND, HX8369_CMD_BOE_2_DISP_OFF},
	{DISPCTRL_SLEEP_MS, 50},	
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T hx8369_boe_2_id[] = {
...
__initdata DISPCTRL_REC_T hx8369_boe_2_slp_in[] = {
	{DISPCTRL_WR_CMND, HX8369_CMD_BOE_2_SLEEP_IN},
	{DISPCTRL_SLEEP_MS, 32},
	{DISPCTRL_LIST_END, 0}
};

__initdata DISPCTRL_REC_T hx8369_boe_2_slp_out[] = {
	{DISPCTRL_WR_CMND, HX8369_CMD_BOE_2_SLEEP_OUT},
...
__initdata DISPCTRL_REC_T hx8369_boe_2_init_panel_vid[] = {
	 {DISPCTRL_WR_CMND, HX8369_CMD_BOE_2_ENABLE_CMD},
...
void hx8369_boe_2_winset(char *msgData, DISPDRV_WIN_t *p_win)
{
	return;
}

__initdata struct lcd_config hx8369_boe_2_cfg = {
	.name = "HX8369_BOE_2",
	.mode_supp = LCD_VID_ONLY,
	.phy_timing = &hx8369_boe_2_timing[0],
	.max_lanes = 2,
	...
	.phys_height = 99,
	.init_cmd_seq = NULL,
	.init_vid_seq = &hx8369_boe_2_init_panel_vid[0],
	.slp_in_seq = &hx8369_boe_2_slp_in[0],
	.slp_out_seq = &hx8369_boe_2_slp_out[0],
	.scrn_on_seq = &hx8369_boe_2_scrn_on[0],
	.scrn_off_seq = &hx8369_boe_2_scrn_off[0],
	.id_seq = &hx8369_boe_2_id[0],
	.verify_id = false,	
	.updt_win_fn = hx8369_boe_2_winset,
	.updt_win_seq_len = 0,
	.vid_cmnds = false,
	.vburst = true,
	.cont_clk = false,
