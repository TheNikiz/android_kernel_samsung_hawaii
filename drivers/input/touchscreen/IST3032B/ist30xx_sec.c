...
#if defined(CONFIG_MACH_HAWAII_SS_VIVALTONFC3G) || (CONFIG_MACH_HAWAII_SS_VIVALTODS5M)
...
#define SEC_DEFAULT_ATTR    (S_IRUGO)
/* sysfs - touchscreen */
...
/* sysfs - tsp */
static DEVICE_ATTR(close_tsp_test, SEC_DEFAULT_ATTR, show_close_tsp_test, NULL);
static DEVICE_ATTR(cmd, S_IWUSR | S_IWGRP, NULL, store_cmd);
static DEVICE_ATTR(cmd_status, SEC_DEFAULT_ATTR, show_cmd_status, NULL);
static DEVICE_ATTR(cmd_result, SEC_DEFAULT_ATTR, show_cmd_result, NULL);
