...
#if 1 //defined(CONFIG_MACH_HAWAII_SS_LOGAN_REV03) || defined(CONFIG_MACH_HAWAII_SS_LOGANDS_REV01) || defined(CONFIG_MACH_HAWAII_SS_HEAT3G_REV00) || defined(CONFIG_MACH_HAWAII_SS_HEAT3G_REV01)
