...
#define EXIF_MODEL			"GT-B7272"
	...
	|| defined(CONFIG_MACH_HAWAII_SS_HEATNFC3G_REV00) 
...
#define CAM0_RESET			111 
#define CAM0_STNBY			2
#define CAM1_RESET			5 //4
#define CAM1_STNBY			4 //5
#define EXIF_MODEL			"GT-B7272"
#define VCAM_CORE_1_2V_REGULATOR	"vsrldo"
#define VCAM_CORE_1_2V_REGULATOR_uV	1200000
#define VCAM_CORE_1_2V_REGULATOR_NEEDED
...
static const struct v4l2_ctrl_config sr030pc50_controls[] = {
	...
	
	{
		...
		.max		= (1 << FRAME_RATE_AUTO |/* 1 << FRAME_RATE_5 | 1 << FRAME_RATE_7 |*/ 1 << FRAME_RATE_10  | 1 << FRAME_RATE_15
						/*| 1 << FRAME_RATE_20*/ | 1 << FRAME_RATE_25),
		.step		= 1,
		.def		= FRAME_RATE_AUTO,
		.flags 	= 0,
	...
	struct v4l2_exif_sensor_info *exif_param)
{
	...
	CAM_INFO_PRINTK("%s : exposureTime =  %f \n",__func__,exposureTime);
