...
int camdrv_ss_i2c_write_4_bytes_reverse_data(struct i2c_client *client, unsigned short subaddr, unsigned short data);
int camdrv_ss_i2c_write_3_bytes(struct i2c_client *client, unsigned short subaddr, unsigned short data);
int camdrv_ss_i2c_read_2_bytes(struct i2c_client *client, unsigned short subaddr, unsigned short *data);
int camdrv_ss_i2c_read_2_bytes_1(struct i2c_client *client, unsigned short subaddr, unsigned short *data);
int camdrv_ss_i2c_read_2_bytes_2(struct i2c_client *client, unsigned short subaddr,	unsigned short *data);
...
/* Optional */
	int (*checkwait_for_mode_transition)(struct v4l2_subdev *sd, int imode);
	int (*calibrateSensor)(struct v4l2_subdev *sd);
	int (*set_preview_start)(struct v4l2_subdev *sd);
	int (*set_vcm_off)(struct v4l2_subdev *sd);
	...
	int (*set_ev)(struct v4l2_subdev *sd, int mode);  
