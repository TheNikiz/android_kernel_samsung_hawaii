...
/* individual configuration */
	...
	|| defined(CONFIG_MACH_HAWAII_SS_LOGANDS_REV01) || defined(CONFIG_MACH_HAWAII_SS_HEAT3G_REV00)\
	|| defined(CONFIG_MACH_JAVA_SS_EVAL_REV00) || defined(CONFIG_MACH_JAVA_SS_BAFFINLITE_REV00)\
	|| defined(CONFIG_MACH_JAVA_SS_VICTOR3G_REV00) || defined(CONFIG_MACH_HAWAII_SS_HEAT3G_REV01)\
	|| defined(CONFIG_MACH_HAWAII_SS_HEATNFC3G_REV00) || defined(CONFIG_MACH_HAWAII_SS_VIVALTONFC3G_REV00) || defined(CONFIG_MACH_HAWAII_SS_VIVALTODS5M_REV00)
...
static int camdrv_ss_db8v61m_sensor_power(struct v4l2_subdev *sd, int on)
{
	unsigned int value;
	int ret = -1;
	struct clk *clock;
