...
static struct platform_device heatnfc_panel_device = {
	.name = "heatnfc",
	.id = -1,
};
...
static void __init hawaii_init(void)
{
	...
	platform_device_register(&heatnfc_panel_device);
...
MACHINE_START(HAWAII, "hawaii_ss_heatnfc3g")
