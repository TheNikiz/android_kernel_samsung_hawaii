...
void check_musb_chip(void)
{
	...
	printk(KERN_INFO
		"niconico previously system_rev Revision: %u\n",
		system_rev);
  ...
  || defined(CONFIG_MACH_HAWAII_SS_HEAT3G_REV01) || defined(CONFIG_MACH_HAWAII_SS_HEATNFC3G_REV00) || defined(CONFIG_MACH_HAWAII_SS_VIVALTONFC3G_REV00) || defined(CONFIG_MACH_HAWAII_SS_VIVALTODS5M_REV00)
	system_rev = 0x1;
	pr_info("niconico DS01/Heat00 system_rev Revision: %u\n", system_rev);
#endif
#if defined(CONFIG_MACH_HAWAII_SS_LOGANDS_REV00)
	system_rev = 0x0;
	pr_info("niconico DS00 system_rev Revision: %u\n", system_rev);
#endif
	pr_info("niconico final system_rev Revision: %u\n", system_rev);
	if (system_rev == 1) {
...
#ifdef CONFIG_RT8973
		pr_info("niconico LoganDS01 RT8973 MUIC\n");
		use_muic_rt8973 = 1;
#endif
#endif
	...
	|| defined(CONFIG_MACH_HAWAII_SS_HEAT3G_REV00)
#ifdef CONFIG_USB_SWITCH_TSU6111
		pr_info("niconico LoganDS00 TSU6111 MUIC\n");
		use_muic_tsu6111 = 1;
#endif
#endif
	...
	|| defined(CONFIG_MACH_HAWAII_SS_HEAT3G_REV00)
#ifdef CONFIG_RT8973
		pr_info("niconico KyleVE00/JBTLP00/KyleVESS00/HEAT RT8973  MUIC\n");
		use_muic_rt8973 = 1;
#endif
#endif
	} else {
		pr_info("niconico not 00 nor 01 Please Check this line\n");
#ifdef CONFIG_RT8973
		use_muic_rt8973 = 1;
#endif
	}
