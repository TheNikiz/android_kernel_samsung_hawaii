...
/* TODO regulator */
	...
	/* heatnfc rev00 Xtal RTC = 18pF shows 32768.12Hz */
...
struct bcmpmu59xxx_regulator_init_data
	...
	#if defined(CONFIG_MACH_HAWAII_SS_HEAT3G_REV00) \
			|| defined(CONFIG_MACH_HAWAII_SS_HEAT3G_REV01)|| defined(CONFIG_MACH_HAWAII_SS_HEATNFC3G_REV00)
...
/* SS SDI Heatnfc3G profile 2014.2.12 */
static struct batt_volt_cap_map ss_heatnfc3g_volt_cap_lut[] = {
	{4319, 100},
	{4258, 95 },
	{4201, 90 },
	{4148, 85 },
...
/* SS SDI Heatnfc3G off -15% profile 2014.2.12 */
static struct batt_eoc_curr_cap_map ss_heatnfc3g_eoc_cap_lut[] = {
	 {408, 90 },
	 {408, 91 },
	 {395, 92 },
	 {359, 93 },
...
#if defined(PMU_BATT_CUTOFF_EXTENDED)
static struct batt_cutoff_cap_map ss_heatnfc3g_cutoff_cap_lut[] = {
	{3450, 2  },
	{3350, 1  },
	{3300, 0},
...
/* SS SDI#1 Heatnfc3G profile 2014.2.12 */
static struct batt_esr_temp_lut ss_heatnfc3g_esr_temp_lut[] = {
	{
		.temp = -200,
		.reset=0, .fct=250, .guardband=50,
		.esr_vl_lvl = 3802, .esr_vl_slope = -13379, .esr_vl_offset=53038,
		.esr_vm_lvl = 3987, .esr_vm_slope = -786, .esr_vm_offset=5163,
		.esr_vh_lvl = 4257, .esr_vh_slope = 1311, .esr_vh_offset=-3199,
				    .esr_vf_slope = -13039, .esr_vf_offset=57895,
	},

	{
		.temp = -100,
		.reset=0, .fct=578, .guardband=50,
		.esr_vl_lvl = 3694, .esr_vl_slope = -90825, .esr_vl_offset=337594,
		.esr_vm_lvl = 3844, .esr_vm_slope = -5633, .esr_vm_offset=22878,
		.esr_vh_lvl = 4148, .esr_vh_slope = 926, .esr_vh_offset=-2335,
				    .esr_vf_slope = -3743, .esr_vf_offset=17034,
	},

	{
		.temp = 0,
		.reset=0, .fct=777, .guardband=30,
		.esr_vl_lvl = 3690, .esr_vl_slope = -4980, .esr_vl_offset=20134,
		.esr_vm_lvl = 3819, .esr_vm_slope = -8294, .esr_vm_offset=32363,
		.esr_vh_lvl = 4060, .esr_vh_slope = 988, .esr_vh_offset=-3082,
				    .esr_vf_slope = -1708, .esr_vf_offset=7864,
	},

	{
		.temp = 100,
		.reset=0, .fct=921, .guardband=30,
		.esr_vl_lvl = 3844, .esr_vl_slope = -4574, .esr_vl_offset=18011,
		.esr_vm_lvl = 4060, .esr_vm_slope = 712, .esr_vm_offset=-2308,
		.esr_vh_lvl = 4319, .esr_vh_slope = -1041, .esr_vh_offset=4810,
				    .esr_vf_slope = -2230, .esr_vf_offset=9946,
	},

	{
		.temp=250,
		.reset = 0, .fct = 1000, .guardband = 30,
		.esr_vl_lvl = 3592, .esr_vl_slope = -2727, .esr_vl_offset=10373,
		.esr_vm_lvl = 3689, .esr_vm_slope = -1948, .esr_vm_offset=7574,
		.esr_vh_lvl = 3694, .esr_vh_slope = -19487, .esr_vh_offset=72277,
				    .esr_vf_slope = -113, .esr_vf_offset=706,
	},
};

/* SS SDI#1 Heatnfc3G profile 2014.2.12 */
static struct bcmpmu_batt_property ss_heatnfc3g_props = {
	.model = "SS SDI",
#if defined(PMU_BATT_CUTOFF_EXTENDED)
	.min_volt = 3300,
#else
	...
	.full_cap = 1500 * 3600,
	.one_c_rate = 1500,
	.volt_cap_lut = ss_heatnfc3g_volt_cap_lut,
	.volt_cap_lut_sz = ARRAY_SIZE(ss_heatnfc3g_volt_cap_lut),
	.esr_temp_lut = ss_heatnfc3g_esr_temp_lut,
	.esr_temp_lut_sz = ARRAY_SIZE(ss_heatnfc3g_esr_temp_lut),
	.eoc_cap_lut = ss_heatnfc3g_eoc_cap_lut,
	.eoc_cap_lut_sz = ARRAY_SIZE(ss_heatnfc3g_eoc_cap_lut),
	.cutoff_cap_lut = ss_heatnfc3g_cutoff_cap_lut,
	.cutoff_cap_lut_sz = ARRAY_SIZE(ss_heatnfc3g_cutoff_cap_lut),
};

static struct bcmpmu_batt_cap_levels ss_heatnfc3g_cap_levels = {
	.critical = 2,
	.low = 15,
	.normal = 75,
	.high = 95,
...
/* SS SDI#1 Heatnfc3G profile 2014.2.12 */
static struct bcmpmu_batt_volt_levels ss_heatnfc3g_volt_levels = {
#if defined(PMU_BATT_CUTOFF_EXTENDED)
	.critical = 3450,
#else
	.critical = 3510,
...
static struct bcmpmu_batt_cal_data ss_heatnfc3g_cal_data = {
	.volt_low = 3550,
	.cap_low = 2,
};

static struct bcmpmu_fg_pdata fg_pdata = {
	.batt_prop = &ss_heatnfc3g_props,
	.cap_levels = &ss_heatnfc3g_cap_levels,
	.volt_levels = &ss_heatnfc3g_volt_levels,
	.cal_data = &ss_heatnfc3g_cal_data,
	.sns_resist = 10,
	.sys_impedence = 33,
	...
	/* heatnfc3g R01 bd: 21 Nov 2013. Max err 0.786 */
	.fg_factor = 972,
...
struct spa_power_data spa_data = {
	...
	.charging_cur_wall = 695, //output regulation
	.charging_cur_cdp_usb = 695, //output regulation
