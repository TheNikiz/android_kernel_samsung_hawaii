...
static struct batt_volt_cap_map ss_vivaltonfc3g_volt_cap_lut[] = {
	{4320, 100},
	{4252, 95 },
	{4190, 90 },
	{4133, 85 },
...
/* SS Elentech Vivaltonfc3G off -15% profile 2014.2.12 */
static struct batt_eoc_curr_cap_map ss_vivaltonfc3g_eoc_cap_lut[] = {
	 {408, 90 },
	 {408, 91 },
	 {395, 92 },
	 {359, 93 },
...
#if defined(PMU_BATT_CUTOFF_EXTENDED)
static struct batt_cutoff_cap_map ss_vivaltonfc3g_cutoff_cap_lut[] = {
	{3400, 2  },
	{3350, 1  },
	{3300, 0},
...
/* SS Elentech Vivalto3G profile 2014.4.25 */
static struct batt_esr_temp_lut ss_vivaltonfc3g_esr_temp_lut[] = {
	{
		.temp = -200,
...
/* SS Elentech#1 Vivaltonfc3G profile 2014.4.25 */
static struct bcmpmu_batt_property ss_vivaltonfc3g_props = {
	.model = "SS Elentech",
#if defined(PMU_BATT_CUTOFF_EXTENDED)
	.min_volt = 3300,
#else
	...
	.full_cap = 1500 * 3600,
	.one_c_rate = 1500,
	.volt_cap_lut = ss_vivaltonfc3g_volt_cap_lut,
	.volt_cap_lut_sz = ARRAY_SIZE(ss_vivaltonfc3g_volt_cap_lut),
	.esr_temp_lut = ss_vivaltonfc3g_esr_temp_lut,
	.esr_temp_lut_sz = ARRAY_SIZE(ss_vivaltonfc3g_esr_temp_lut),
	.eoc_cap_lut = ss_vivaltonfc3g_eoc_cap_lut,
	.eoc_cap_lut_sz = ARRAY_SIZE(ss_vivaltonfc3g_eoc_cap_lut),
	.cutoff_cap_lut = ss_vivaltonfc3g_cutoff_cap_lut,
	.cutoff_cap_lut_sz = ARRAY_SIZE(ss_vivaltonfc3g_cutoff_cap_lut),
};

static struct bcmpmu_batt_cap_levels ss_vivaltonfc3g_cap_levels = {
	.critical = 2,
	.low = 15,
	.normal = 75,
	.high = 95,
...
/* SS Elentech Vivaltonfc3G profile 2014.4.25 */
static struct bcmpmu_batt_volt_levels ss_vivaltonfc3g_volt_levels = {
#if defined(PMU_BATT_CUTOFF_EXTENDED)
	.critical = 3400,
#else
	.critical = 3510,
...
static struct bcmpmu_batt_cal_data ss_vivaltonfc3g_cal_data = {
	.volt_low = 3300,
	.cap_low = 0,
};

static struct bcmpmu_fg_pdata fg_pdata = {
	.batt_prop = &ss_vivaltonfc3g_props,
	.cap_levels = &ss_vivaltonfc3g_cap_levels,
	.volt_levels = &ss_vivaltonfc3g_volt_levels,
	.cal_data = &ss_vivaltonfc3g_cal_data,
	.sns_resist = 10,
	.sys_impedence = 33,
	...
	/* vivaltonfc3g R01 bd: 21 Nov 2013. Max err 0.786 */
	.fg_factor = 972,
