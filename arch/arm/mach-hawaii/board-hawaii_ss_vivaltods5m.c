...
#include <mach/dev-hawaii_vivaltods5m_nfc.h>
#include <mach/dev-hawaii_vivaltods5m_tsp.h>
...
#endif /* CONFIG_BACKLIGHT_KTD2801_VIVALTODS5M */
...
#if	defined(CONFIG_BACKLIGHT_KTD259B) || defined(CONFIG_BACKLIGHT_KTD2801) || defined(CONFIG_BACKLIGHT_KTD2801_VIVALTONFC3G) || defined(CONFIG_BACKLIGHT_KTD2801_VIVALTODS5M)
...
MACHINE_START(HAWAII, "hawaii_ss_vivaltods5m")
