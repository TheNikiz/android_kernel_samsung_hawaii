...
/* TODO regulator */
	...
	/* Heat rev00 Xtal RTC = 18pF shows 32768.12Hz */
...
/* SS B100BE profile */
static struct batt_volt_cap_map ss_heat3g_volt_cap_lut[] = {
	{4321, 100},
	{4250, 95},
	{4183, 90},
	{4126, 85},
...
static struct batt_eoc_curr_cap_map ss_heat3g_eoc_cap_lut[] = {
	 {290, 90},
	 {270, 91},
	 {250, 92},
	 {228, 93},
...
static struct batt_cutoff_cap_map ss_heat3g_cutoff_cap_lut[] = {
	{3380, 2},
	{3340, 1},
	{3300, 0},
};
...
/* SS B100BE profile */
static struct batt_esr_temp_lut ss_heat3g_esr_temp_lut[] = {
	{
		.temp = -200,
...
/* SS B100BE profile */
static struct bcmpmu_batt_property ss_heat3g_props = {
	.model = "SS B100BE",
#if defined(PMU_BATT_B100AE_CUTOFF_EXTENDED)
	.min_volt = 3300,
#else
	...
	.full_cap = 1500 * 3600,
	.one_c_rate = 1500,
	.volt_cap_lut = ss_heat3g_volt_cap_lut,
	.volt_cap_lut_sz = ARRAY_SIZE(ss_heat3g_volt_cap_lut),
	.esr_temp_lut = ss_heat3g_esr_temp_lut,
	.esr_temp_lut_sz = ARRAY_SIZE(ss_heat3g_esr_temp_lut),
	.eoc_cap_lut = ss_heat3g_eoc_cap_lut,
	.eoc_cap_lut_sz = ARRAY_SIZE(ss_heat3g_eoc_cap_lut),
	.cutoff_cap_lut = ss_heat3g_cutoff_cap_lut,
	.cutoff_cap_lut_sz = ARRAY_SIZE(ss_heat3g_cutoff_cap_lut),
};

static struct bcmpmu_batt_cap_levels ss_heat3g_cap_levels = {
	.critical = 2,
	.low = 15,
	.normal = 75,
	.high = 95,
...
/* SS B100BE profile */
static struct bcmpmu_batt_volt_levels ss_heat3g_volt_levels = {
#if defined(PMU_BATT_B100AE_CUTOFF_EXTENDED)
	.critical = 3380,
#else
	.critical = 3400,
...
static struct bcmpmu_batt_cal_data ss_heat3g_cal_data = {
	.volt_low = 3550,
	.cap_low = 2,
};

static struct bcmpmu_fg_pdata fg_pdata = {
	.batt_prop = &ss_heat3g_props,
	.cap_levels = &ss_heat3g_cap_levels,
	.volt_levels = &ss_heat3g_volt_levels,
	.cal_data = &ss_heat3g_cal_data,
	.sns_resist = 10,
	.sys_impedence = 33,
	...
	/* Heat3g R01 bd: 21 Nov 2013. Max err 0.786 */
	.fg_factor = 942,
