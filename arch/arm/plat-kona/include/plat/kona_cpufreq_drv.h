...
#define RESTORE_MIN_CLOCK (-1)
#define BOOST_MIN_CLOCK 0

#define BITMAP_USER_SPACE_DVFS         0
#define BITMAP_KERNEL_SPACE_DVFS_KSM   1
#define BITMAP_KERNEL_SPACE_DVFS_TOUCH 2
