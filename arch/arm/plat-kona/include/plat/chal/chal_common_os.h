...
*
*****************************************************************************/
#define CHAL_REG_READ8(addr)  readb((void volatile*)addr)
#define CHAL_REG_READ16(addr) readw((void volatile*)addr)
#define CHAL_REG_READ32(addr) readl((void volatile*)addr)

#define CHAL_REG_WRITE8(addr, val)  writeb(val, (void volatile*)addr)
#define CHAL_REG_WRITE16(addr, val) writew(val, (void volatile*)addr)
#define CHAL_REG_WRITE32(addr, val) writel(val, (void volatile*)addr)
