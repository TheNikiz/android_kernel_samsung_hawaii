...
#elif defined(CONFIG_MACH_HAWAII_SS_HEAT3G) || defined(CONFIG_MACH_HAWAII_SS_HEATNFC3G) || defined(CONFIG_MACH_HAWAII_SS_VIVALTONFC3G)  || defined(CONFIG_MACH_HAWAII_SS_VIVALTODS5M)
	0x2600,			/* MDIO Register 3 initial value 0x2600 */
#else
	0x0000,			/* MDIO Register 3 initial value 0x0000 */
#endif
	0x0130,			/* MDIO Register 4 initial value 0x0020 */
