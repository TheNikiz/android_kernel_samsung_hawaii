...
#ifdef CONFIG_TOUCHSCREEN_MELFAS_MMS144
#include "board-tsp-mms144.c"
#endif
...
#ifdef CONFIG_TOUCHSCREEN_MELFAS_MMS144
	pr_info("=== board_tsp_init_mms144 ===\n");
	board_tsp_init_mms144();
#endif

#ifdef CONFIG_TOUCHSCREEN_MELFAS_MMS136
	pr_info("=== board_tsp_init_mms136 ===\n");
	board_tsp_init_mms136();
#endif
