...
enum v4l2_touch_af {
	...
	TOUCH_AF_START,
	TOUCH_AF_MAX,
	TOUCH_FOCUS_1ST_CANCEL,
	TOUCH_FOCUS_2ND_CANCEL,
...
#define V4L2_CID_CAMERA_SAMSUNG     (V4L2_CID_PRIVATE_BASE + 129)
...
#define V4L2_CID_CAMERA_READ_CAM_MODE		(V4L2_CID_PRIVATE_BASE + 137)
...
#define V4L2_CID_CAMERA_READ_CAM_MODE		(V4L2_CID_USER_BASE | 0x108C)
#define V4L2_CID_CAMERA_SAMSUNG     (V4L2_CID_USER_BASE + 0x108D)
