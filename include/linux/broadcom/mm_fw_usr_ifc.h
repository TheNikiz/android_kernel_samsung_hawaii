...
enum {
	...
	MM_CMD_SET_BUFFER_UPDATED,
	MM_CMD_SET_BUFFER_SYNCED,
	MM_CMD_GET_BUFFER_STATUS,
	MM_CMD_MEMC_SET,
	MM_CMD_MEMC_RESET,
	MM_CMD_GET_HWC_BUFFER,
	MM_CMD_GET_GL_BUFFER,
	MM_CMD_GET_SW_BUFFER,
	MM_CMD_GET_ENC_BUFFER,
	MM_CMD_LAST
};
...
#define mm_gralloc_alloc_t   struct mm_gralloc_alloc_t_
...
#define MM_IOCTL_SET_BUFFER_UPDATED _IOWR(MM_DEV_MAGIC, \
		MM_CMD_SET_BUFFER_UPDATED, int)

#define MM_IOCTL_SET_BUFFER_SYNCED _IOWR(MM_DEV_MAGIC, \
		MM_CMD_SET_BUFFER_SYNCED, int)

#define MM_IOCTL_GET_BUFFER_STATUS _IOWR(MM_DEV_MAGIC, \
		MM_CMD_GET_BUFFER_STATUS, int*)

#define MM_IOCTL_MEMC_SET _IOWR(MM_DEV_MAGIC, MM_CMD_MEMC_SET, int)

#define MM_IOCTL_MEMC_RESET _IOWR(MM_DEV_MAGIC, MM_CMD_MEMC_RESET, int)
...
#define MM_IOCTL_GET_HWC_BUFFER _IOWR(MM_DEV_MAGIC, MM_CMD_GET_HWC_BUFFER, \
		mm_gralloc_alloc_t)

#define MM_IOCTL_GET_GL_BUFFER _IOWR(MM_DEV_MAGIC, MM_CMD_GET_GL_BUFFER, \
		mm_gralloc_alloc_t)

#define MM_IOCTL_GET_SW_BUFFER _IOWR(MM_DEV_MAGIC, MM_CMD_GET_SW_BUFFER, \
		mm_gralloc_alloc_t)

#define MM_IOCTL_GET_ENC_BUFFER _IOWR(MM_DEV_MAGIC, MM_CMD_GET_ENC_BUFFER, \
		mm_gralloc_alloc_t)
